      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {data?.data.map(item => {
            ...
            return (
              <div key={item.id} className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl p-4 hover:border-slate-300 dark:hover:border-zinc-700 transition-colors shadow-sm">
